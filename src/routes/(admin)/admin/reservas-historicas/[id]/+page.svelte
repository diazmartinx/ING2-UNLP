<script lang="ts">
    ...
    interface Reserva {
        ...
        precioPorDia: number;
        importeTotal: number;
        importeAdicionales: number; // Nuevo campo para importe de adicionales
    }

    export let data: PageData;
    const { reserva, error } = data as { reserva?: Reserva; error?: string };
    const { adicionalesReserva = [] } = data as any;
...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <a href="/admin/reservas-historicas" class="text-blue-600 hover:text-blue-800 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M9.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L7.414 9H15a1 1 0 110 2H7.414l2.293 2.293a1 1 0 010 1.414z" clip-rule="evenodd" />
            </svg>
            Volver a Historial de Reservas
        </a>
    </div>
